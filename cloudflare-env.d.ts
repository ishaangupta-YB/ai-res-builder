/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 348019c63487d276d3e1d5c1ad7deda3)
// Runtime types generated with workerd@1.20260212.0 2025-12-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		R2_BUCKET: R2Bucket;
		ai_resume_uploads: R2Bucket;
		DB: D1Database;
		...
		BASE_URL: string;
		WORKER_SELF_REFERENCE: Fetcher /* ai-res-builder */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "BETTER_AUTH_URL" | "BASE_URL">> {}
}
